...
export default function GerenciaSupportPage() {
    ...
    <div className="h-[calc(100vh-10rem)] bg-background flex flex-col md:flex-row gap-6 animate-in fade-in duration-500 rounded-xl overflow-hidden">
      ...
      <Card className={cn(
        ...
        <div className="p-4 border-b border-border">
          <h2 className="text-xl font-bold tracking-tight">Soporte TI</h2>
          <p className="text-xs text-muted mt-1">Reporta incidencias y conversa con el equipo de TI.</p>
          <div className="mt-3">
            <ReportarIncidenteButton role="GERENCIA_GENERAL" className="w-full" />
          </div>
        </div>
            ...
            <>
              ...
              >
                <div className="relative shrink-0">
                  <div className="h-10 w-10 flex items-center justify-center rounded-full bg-emerald-500 text-black">
                ...
                <div className="flex-1 min-w-0 text-sm">
                  <div className="flex items-center justify-between gap-1">
                    <p className="font-bold text-emerald-500 truncate">Soporte Técnico IS</p>
          ...
          <>
            ...
            <div className="h-16 shrink-0 border-b border-border flex items-center justify-between px-4 md:px-6 bg-surface-secondary/20">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <div className="h-10 w-10 flex items-center justify-center rounded-full bg-emerald-500 text-black shrink-0">
                  <Headphones className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="font-bold text-sm text-emerald-500">Soporte Técnico IS</h3>
                  <p className="text-xs text-muted">Equipo de Soporte</p>
                </div>
              </div>
